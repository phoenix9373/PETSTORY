package com.ssafy.petstory.postlist.controller;

import com.ssafy.petstory.board.controller.BoardApiController;
...
import com.ssafy.petstory.postlist.service.MemberPostlistService;
import com.ssafy.petstory.postlist.service.PostlistService;
...
public class PostlistController {
    ...
    public Result<BoardQueryDto> findAllPaging(@RequestParam(value = "offset") int offset,
        ...
        return new Result(postlistService.findPostlistPaging(offset, limit, memberPostlistId, profile_id));
    }
