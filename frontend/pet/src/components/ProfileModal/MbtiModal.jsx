  ...
  render() {
            ...
            <div className="small-question-box">
              <div className="questionA">
                <label>
                  ...
                  <input type="checkbox" value="E" onChange={this.next}></input>
                </label>
              </div>
              <label>
                <h3>알아서 모셔라</h3>
                ...
                <p>가끔은 안아야 하는 댕댕이</p>
                <input type="checkbox" value="Q" onChange={this.next}></input>
              </label>
            </div>
          </div>
          <div>
            ...
            <div className="small-question-box">
              <div className="questionA">
                <label>
                  ...
                  <input type="checkbox" value="S" onChange={this.next}></input>
                </label>
              </div>
              <div className="questionB">
                <label>
                  ...
                  <input type="checkbox" value="I" onChange={this.next}></input>
                </label>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="small-question-box">
              <label>
                ...
                <input type="checkbox" value="W" onChange={this.next}></input>
              </label>
              <label>
                <h3>호기심 대마왕</h3>
                <img src={placeB} alt="낯선장소b" />
                <p>궁금한게 넘 많아! 빨빨 돌아다니는 댕댕이</p>
                <input type="checkbox" value="A" onChange={this.next}></input>
              </label>
            </div>
          </div>
          <div>
            ...
            <div className="small-question-box">
              <div className="questionA">
                <label>
                  ...
                  <input type="checkbox" value="C" onChange={this.next}></input>
                </label>
              </div>
              <div className="questionB">
                <label>
                  ...
                  <input type="checkbox" value="F" onChange={this.next}></input>
                </label>
              </div>
            </div>
          </div>
    ...
    return (
      <Modal
        ...
        onRequestClose={this.closeMbtiTestModal}
      >
        {body}
      </Modal>
    );
